"""
This script creates tables and figures from the OG-IND documentation.
"""
...
UN_COUNTRY_CODE = "356"  # UN population data country code for India is 356
...
p.update_specifications(
    "github://OpenSourceEcon:OG-IND@main/ogind/ogind_default_parameters.json"
)
